...
def shift_fds():
    ...
    global laber_sravn4
    if k == 1:
        shift(for_rezim1,for_rezim2)
        first = for_rezim1[:-4] + "_shift" + for_rezim1[-4:]
        second = for_rezim2[:-4] + "_shift" + for_rezim2[-4:]
...
def switch_pokas():
    ...
    global panel6
    btn1.pack()
    btn1.place(x=620, y=200)
    btn2.pack()
    btn2.place(x=0, y=680)
    btn3.pack()
    btn3.place(x=0, y=625)
    btn4.pack()
    btn4.place(x=680, y=625)
    btn5.pack()
    btn5.place(x=1150, y=625)
    btn6.pack()
    btn6.place(x=370, y=625)
    btn8.pack()
    btn8.place(x=370, y=680)
    btn9.pack()
    btn9.place(x=370, y=735)
    btn10.pack()
    btn10.place(x=1150, y=680)
    btn11.pack()
    btn11.place(x=1150, y=735)
    btn12.pack()
    btn12.place(x=720, y=680)
    btn13.pack()
...
btn8 = Button(text="Прибавление размытия(Гаусса)",command=sigma_change_plus, background="#555", foreground="#ccc", padx="14", pady="7", font="13")
btn8.pack()
btn8.place(x=370, y=680)

btn9 = Button(text="Уменьшение размытия(Гаусса)",command=sigma_change_minus, background="#555",foreground="#ccc", padx="14", pady="7", font="13")
btn9.pack()
btn9.place(x=370, y=735)
...
btn11 = Button(text="Уменьшение mean размытие",command=mean_per_change_minus, background="#555",foreground="#ccc", padx="14", pady="7", font="13")
btn11.pack()
btn11.place(x=1150, y=735)

btn12 = Button(text="Прибавление men размытие",command=men_per_change_plus, background="#555", foreground="#ccc", padx="14", pady="7", font="13")
btn12.pack()
btn12.place(x=720, y=680)

btn13 = Button(text="Уменьшение men размытие",command=men_per_change_minus, background="#555",foreground="#ccc", padx="14", pady="7", font="13")
btn13.pack()
btn13.place(x=720, y=735)
...
btn20 = Button(text="shiiiiiift",command=shift_fds, background="#555",foreground="#ccc", padx="14", pady="7", font="13")
btn20.pack()
btn20.place(x=500, y=0)
